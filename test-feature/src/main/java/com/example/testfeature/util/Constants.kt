...
const val fakeFirstPhotoIsPublic = 1
const val fakeFirstPhotoIsFriend = 0
const val fakeFirstPhotoIsFamily = 1
...
const val fakeSecondPhotoIsPublic = 0
const val fakeSecondPhotoIsFriend = 1
const val fakeSecondPhotoIsFamily = 0
